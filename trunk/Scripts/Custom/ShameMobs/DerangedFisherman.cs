...
namespace Server.Mobiles
{
	...
	public class DerangedFisherman : BaseCreature
	{
		[Constructable]
		public DerangedFisherman() : base( AIType.AI_Melee, FightMode.Closest, 6, 1, 0.2, 0.4 )
		{
		...
		public DerangedFisherman( Serial serial ) : base( serial )
		{
		}
