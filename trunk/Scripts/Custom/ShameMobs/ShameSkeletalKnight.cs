...
namespace Server.Mobiles
{
	...
	public class ShameSkeletalKnight : BaseCreature
	{
		[Constructable]
		public ShameSkeletalKnight() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public ShameSkeletalKnight( Serial serial ) : base( serial )
		{
		}
