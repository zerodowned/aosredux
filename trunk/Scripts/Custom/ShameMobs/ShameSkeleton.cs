...
namespace Server.Mobiles
{
	...
	public class ShameSkeleton : BaseCreature
	{
		[Constructable]
		public ShameSkeleton() : base( AIType.AI_Melee, FightMode.Closest, 8, 1, 0.25, 0.5 )
		{
			Name = "a skeleton";
		...
		public ShameSkeleton( Serial serial ) : base( serial )
		{
		}
