...
namespace Server.Misc
{
	public class CharacterCreation
	{
		...
		private static void EventSink_CharacterCreated( CharacterCreatedEventArgs args )
		{
			...
			CityInfo city = new CityInfo( "Moonglow", "The Scholar's Inn", 4404, 1169, 10, Map.Felucca );
		...
		private static void FixStats( ref int str, ref int dex, ref int intel )
		{
			...
			FixStat( ref vStr, (vStr + vDex + vInt) - 70 );
			FixStat( ref vDex, (vStr + vDex + vInt) - 70 );
			FixStat( ref vInt, (vStr + vDex + vInt) - 70 );
		...
		private static void SetStats( Mobile m, int str, int dex, int intel )
		{
			...
			if ( str < 10 || str > 70 || dex < 10 || dex > 70 || intel < 10 || intel > 70 || (str + dex + intel) != 210 )
			{
				str = 70;
				dex = 70;
				intel = 70;
		...
		private static void SetSkills( Mobile m, SkillNameValue[] skills, int prof )
		{
			switch ( prof )
			{
				case 1: // Warrior
				{
					skills = new SkillNameValue[]
						{
							new SkillNameValue( SkillName.Anatomy, 75 ),
							new SkillNameValue( SkillName.Healing, 75 ),
							new SkillNameValue( SkillName.Fencing, 75 ),
							new SkillNameValue( SkillName.Tactics, 75 )
						};
				...
				case 2: // Magician
				{
					skills = new SkillNameValue[]
						{
							new SkillNameValue( SkillName.EvalInt, 75 ),
							new SkillNameValue( SkillName.Anatomy, 75 ),
							new SkillNameValue( SkillName.Magery, 75 ),
							new SkillNameValue( SkillName.Meditation, 75 )
						};
					...
					skills = new SkillNameValue[]
						{
							...
							new SkillNameValue( SkillName.Tailoring, 50 ),
				...
				case 4: // Necromancer
				{
					skills = new SkillNameValue[]
						{
							new SkillNameValue( SkillName.Necromancy, 75 ),
							new SkillNameValue( SkillName.Magery, 75 ),
							new SkillNameValue( SkillName.SpiritSpeak, 75 ),
							new SkillNameValue( SkillName.Meditation, 75 ),
						};
				...
				case 5: // Paladin
				{
					skills = new SkillNameValue[]
						{
							new SkillNameValue( SkillName.Chivalry, 75 ),
							new SkillNameValue( SkillName.Swords, 75 ),
							new SkillNameValue( SkillName.Focus, 75 ),
							new SkillNameValue( SkillName.Tactics, 75 )
						};
			...
			switch ( prof )
			{
				...
				case 4: // Necromancer
				{
					Container regs = new BagOfNecroReagents( 150 );
