...
namespace Server.Engines.VeteranRewards
{
	public class RewardSystem
	{
		...
		public static TimeSpan RewardInterval = TimeSpan.FromDays( 1.0 );
		...
		public static void SetupRewardTables()
		{
			...
			const int Bronze = 0x3E7;
			const int Copper = 0x3E7;
			const int Golden = 0x3E7;
			const int Agapite = 0x979;
			const int Verite = 0x89F;
			const int Valorite = 0x8AB;
			const int IceGreen = 0x3E7;
			const int IceBlue = 0x3E7;
			const int DarkGray = 0x497;
			const int Fire = 0x3E7;
			const int IceWhite = 0x3E7;
			const int JetBlack = 0x3E7;
			const int Pink		= 0x3E7;
			const int Crimson	= 0x3E7;
			...
			m_Lists = new RewardList[]
				{
					...
					{
						new RewardEntry( houseAddOns,	1076157, typeof( CannonDeed ), Expansion.AOS ),					
